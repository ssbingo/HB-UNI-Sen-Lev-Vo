...
proc set_htmlParams {iface address pps pps_descr special_input_id peer_type} {
  ...
  puts "<script type=\"text/javascript\">load_JSFunc('/config/easymodes/js/HBVOFillingLevelSensor.js');</script>"
  ...
  append HTML_PARAMS(separate_1) "<table class=\"ProfileTbl\">"
    ...
    append HTML_PARAMS(separate_1) "<tr class=\"j_custom\">"                           
      ...
      append HTML_PARAMS(separate_1) "<td>"                                            
        append HTML_PARAMS(separate_1) "<select class=\"stringtable_select\" style=\"width:160px;\" id=$sensorTypeSelectorID name=\"$param\">"
          append HTML_PARAMS(separate_1) "<option value=\"0\">Votronic 12-24K</option>"      
          append HTML_PARAMS(separate_1) "<option value=\"1\">Votronic 15-50K</option>"
          append HTML_PARAMS(separate_1) "<option value=\"2\">Votronic 30-110K</option>"
          append HTML_PARAMS(separate_1) "<option value=\"3\">Votronic 20-K-WC</option>"
    ...
    incr paramNr
    set param "VOLUME_OFFSET"
    set min [getMinValue ps_descr $param]
    set max [getMaxValue ps_descr $param]
    append HTML_PARAMS(separate_1) "<tr class=\"j_custom j_volumeOffset\">"
      append HTML_PARAMS(separate_1) "<td class=\"stringtable_value\">$devType|$param</td>"
    ...
    append HTML_PARAMS(separate_1) "<tr class=\"j_custom j_caseHeight\">"
      ...
      append HTML_PARAMS(separate_1) "<td>"
        ...
        append HTML_PARAMS(separate_1) "<span id=\"caseHeightMinMaxB\" style=\"display:none;\">[getUnit ps_descr $param] (10 - $max)</span>"
      append HTML_PARAMS(separate_1) "</td>"
    append HTML_PARAMS(separate_1) "</tr>"
